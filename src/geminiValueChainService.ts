      ...
      contents: [{
        ...
        parts: [{
          text: `
            ...
            Identify exactly one high-impact mismatch between current operations and the long-term vision. Max 50 words.
          `
        }]
      }],
      ...
      contents: [{
        ...
        parts: [{
          text: `
            ...
            Value Chain Stages: ${JSON.stringify(Object.values(project.stages).filter(s => s.today || s.targetState))}
